class SalasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sala.save
        format.html { redirect_to salas_path, notice: 'Sala criada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @sala.update(sala_params)
        format.html { redirect_to salas_path, notice: 'Sala atualizada com sucesso.' }
  ...
  def sala_params
    params.require(:sala).permit(:predio_id, :nome, :numero, :capacidade)
  end
