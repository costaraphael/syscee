...
class SalasControllerTest < ActionController::TestCase
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post :create, sala: { capacidade: @sala.capacidade, nome: @sala.nome, numero: @sala.numero, predio_id: @sala.predio_id }
    end
  ...
  test "should update sala" do
    patch :update, id: @sala, sala: { capacidade: @sala.capacidade, nome: @sala.nome, numero: @sala.numero, predio_id: @sala.predio_id }
    assert_redirected_to sala_path(assigns(:sala))
  end
