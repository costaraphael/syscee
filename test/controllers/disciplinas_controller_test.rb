...
class DisciplinasControllerTest < ActionController::TestCase
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post :create, disciplina: { curso_id: @disciplina.curso_id, nome: @disciplina.nome, professor_id: @disciplina.professor_id }
    end
  ...
  test "should update disciplina" do
    patch :update, id: @disciplina, disciplina: { curso_id: @disciplina.curso_id, nome: @disciplina.nome, professor_id: @disciplina.professor_id }
    assert_redirected_to disciplina_path(assigns(:disciplina))
  end
