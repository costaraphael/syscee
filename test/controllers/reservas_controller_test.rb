...
class ReservasControllerTest < ActionController::TestCase
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post :create, reserva: { deferente_id: @reserva.deferente_id, espaco_id: @reserva.espaco_id, fim: @reserva.fim, inicio: @reserva.inicio, solicitante_id: @reserva.solicitante_id }
    end
  ...
  test "should update reserva" do
    patch :update, id: @reserva, reserva: { deferente_id: @reserva.deferente_id, espaco_id: @reserva.espaco_id, fim: @reserva.fim, inicio: @reserva.inicio, solicitante_id: @reserva.solicitante_id }
    assert_redirected_to reserva_path(assigns(:reserva))
  end
